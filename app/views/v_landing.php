...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="<?= BASE_URL?>app\assets\libs\landing\images\favicon.png" type="image/png">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="<?= BASE_URL?>app\assets\libs\landing\images\logo.svg" alt="Logo">
                            </a>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="header_hero_content mt-45">
                            <h2 class="header_title wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.2s">PitterPage</h2>
